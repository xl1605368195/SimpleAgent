...
import com.meituan.sec.asm.SmithClassNode;
import com.meituan.sec.asm.SmithClassWriter;
import com.meituan.sec.client.Operate;
import com.meituan.sec.client.ProbeClient;
import com.meituan.sec.client.ProbeNotify;
import com.meituan.sec.log.SmithLogger;
import com.meituan.sec.type.SmithClass;
import com.meituan.sec.type.SmithJar;
import com.meituan.sec.type.SmithTrace;
...
public class SmithProbe implements ClassFileTransformer, ProbeNotify {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) {
        ...
        SmithClassNode classNode = new SmithClassNode(Opcodes.ASM7);
